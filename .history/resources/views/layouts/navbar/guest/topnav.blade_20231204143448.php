<nav
    ...
    <div class="container">
        ...
        <ul class="navbar-nav ms-auto d-flex justify-content-center align-items-md-center">
            <li class="nav-item">
        ...
        <ul class="navbar-nav ms-auto align-items-md-center d-flex justify-content-center">
            @guest
                @if (Route::has('login'))
